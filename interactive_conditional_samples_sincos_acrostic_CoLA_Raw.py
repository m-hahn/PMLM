...
with open(f"/u/scr/mhahn/PRETRAINED/GLUE/glue_data/CoLA/dev_alternatives_PMLM_"+MODEL_NAME.split('/')[-2]+"_raw.tsv", "w") as outFile:
  for batch in BATCHES:
     count += 1
     if count % 100:
       print("fraction of all batches", count/len(BATCHES), "CoLA")
       print(batch[-1])
